...
func NewHandler(healthService *health.Service, meteringService *metering.Service, logger *slog.Logger) *Handler {
	return &Handler{health: healthService, metering: meteringService, logger: logger}
}
